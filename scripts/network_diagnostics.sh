...
echo "  ping -c 3 172.22.223.237"
echo ""
echo "From Computer 2, test Computer 1:"
echo "  ping -c 3 172.26.247.68"
echo ""

echo "8. CRITICAL: Are both computers on the same physical network?"
echo "Computer 1 IP: 172.26.247.68 (subnet: 172.26.x.x)"
echo "Computer 2 IP: 172.22.223.237 (subnet: 172.22.x.x)"
echo ""
